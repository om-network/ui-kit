...
var ToolbarButton = function (_a) {
    var label = _a.label, onTabClick = _a.onTabClick, _b = _a.first, first = _b === void 0 ? false : _b, _c = _a.index, index = _c === void 0 ? 0 : _c, _d = _a.active, active = _d === void 0 ? false : _d, _e = _a.last, last = _e === void 0 ? false : _e, _f = _a.title, title = _f === void 0 ? "" : _f, Icon = _a.icon;
...
var ToolbarDivider = function (_a) {
    var _b = _a.toolBarClasses, toolBarClasses = _b === void 0 ? "mt-4" : _b, children = _a.children, _c = _a.defaultTab, defaultTab = _c === void 0 ? 0 : _c, menu = _a.menu;
    var _d = React.useState(defaultTab), tabNumber = _d[0], setTabNumber = _d[1];
