...
var ClearButton = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "absolute bottom-0 right-0 mr-1 mb-1" },
        react_1.default.createElement("button", { onClick: onClear, type: "button", className: btnClasses },
            react_1.default.createElement(outline_1.TrashIcon, { className: "-ml-0.5 mr-2 h-4 w-4" }),
            label)));
};
var FileUploadField = function (_a) {
    ...
    var _j = react_dropzone_1.useDropzone(__assign(__assign({}, options), { onDrop: onDrop })), getRootProps = _j.getRootProps, getInputProps = _j.getInputProps, isDragActive = _j.isDragActive;
    var file = watch(name);
    ...
    return (react_1.default.createElement("div", { className: wrapperClasses },
        react_1.default.createElement("label", { htmlFor: name, className: "block text-sm leading-5 font-medium text-gray-700" }, label),
        !preview && !file && (react_1.default.createElement("div", __assign({}, getRootProps(), { className: rootClasses }),
            react_1.default.createElement("div", { className: "text-center" },
                react_1.default.createElement(outline_1.CloudUploadIcon, { className: "mx-auto h-8 w-8 text-gray-400" }),
                react_1.default.createElement("p", { className: "mt-1 text-sm text-gray-600" },
                    isDragActive && react_1.default.createElement("span", null, dropFileLabel),
                    !isDragActive && (react_1.default.createElement("span", null,
                        react_1.default.createElement("button", { type: "button", className: uploadClasses }, uploadFileLabel),
                        " ",
                        uploadFileLabelExt))),
                react_1.default.createElement("p", { className: "mt-1 text-xs text-gray-500" }, fileFormatLabel)))),
        !preview && file && (react_1.default.createElement("div", __assign({}, getRootProps(), { className: previewClasses }),
            react_1.default.createElement("img", { className: "object-contain h-20 w-full", src: file.preview, alt: file.name }))),
        preview && (react_1.default.createElement("div", __assign({}, getRootProps(), { className: previewClasses }),
            react_1.default.createElement("img", { className: "object-contain h-20 w-full", src: "" + preview.url, alt: preview === null || preview === void 0 ? void 0 : preview.name }))),
        react_1.default.createElement("input", __assign({}, register(name), getInputProps())),
        !preview && file && react_1.default.createElement(ClearButton, { onClear: onClear }),
        preview && react_1.default.createElement(ClearButton, { onClear: onClear })));
};
