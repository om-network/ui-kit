...
export const FileUploadField: React.FunctionComponent<FileUploadFieldProps & FileUploadFieldDispatch> = ({
    ...
    const previewClasses = classNames("mt-2 flex justify-center p-2 border-2 bg-gray-100 border-gray-100 border-dashed rounded-md");
    const uploadClasses = classNames("font-medium text-gray-600 transition duration-150 ease-in-out", "hover:text-gray-500 focus:outline-none focus:underline");
